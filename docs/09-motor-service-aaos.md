...
**Companion document:** `10-motor-service-someip.md` covers the Pi side. The two must be read
...
The Pi's severity scale is defined in `10-motor-service-someip.md` §3.4. **You map it into
